...
import { ProgrammingBro } from "../assets/ProgrammingBro";

export const Hero: FC = () => {
  return (
    <section className="flex px-5 py-24 md:flex-row flex-col items-center">
      <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
        <ProgrammingBro className="fill-indigo-600 dark:fill-indigo-400" />
      </div>
      <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
        <h1 className="sm:text-4xl text-3xl mb-4 text-gray-900 dark:text-gray-400">
